...
#define KEY_LEFT_FROM_1 0 // has no official key constant, but mapped to 0?
#else
#define KEY_BETWEEN_LSHIFT_AND_Z ALLEGRO_KEY_BACKSLASH2
#define KEY_LEFT_FROM_1 ALLEGRO_KEY_TILDE
#endif
static int keymask[] =
{
  ...
  KEY_LEFT_FROM_1,          ALLEGRO_KEY_Y,        ALLEGRO_KEY_A,            ALLEGRO_KEY_W,       ALLEGRO_KEY_E,          ALLEGRO_KEY_T,         ALLEGRO_KEY_U,       ALLEGRO_KEY_R,
  ALLEGRO_KEY_PAD_ASTERISK, ALLEGRO_KEY_9,        ALLEGRO_KEY_PAD_SLASH,    ALLEGRO_KEY_NUMLOCK, ALLEGRO_KEY_BACKSPACE,  ALLEGRO_KEY_0,         ALLEGRO_KEY_1,       ALLEGRO_KEY_MINUS,
