...
void CreateEmulatorMenu() 
{
  ALLEGRO_MENU_INFO menu_info[] = {
    { _(FILE_MENU_ID), 0, 0, NULL },
      ...
      { __("Insert, Load and Run Cassette..."), FILE_INSERTRUN_CASSETTE_ID, 0, NULL },
      { __("Remove Cassette"), FILE_REMOVE_CASSETTE_ID, 0, NULL },
      ALLEGRO_MENU_SEPARATOR,
      { __("Insert Cartridge..."), FILE_INSERT_CARTRIDGE_ID, 0, NULL },
      { __("Remove Cartridge..."), FILE_REMOVE_CARTRIDGE_ID, 0, NULL },
      ALLEGRO_MENU_SEPARATOR,
      { "Reset (F5)", FILE_RESET_ID, 0, NULL },
      ALLEGRO_MENU_SEPARATOR,
      { __("Save State... (F6)"), FILE_SAVE_STATE_ID, 0, NULL },
      { __("Load State... (Shift-F6)"), FILE_LOAD_STATE_ID, 0, NULL },
      ALLEGRO_MENU_SEPARATOR,
      { __("Save Screenshot... (F7)"), FILE_SAVE_SCREENSHOT_ID, 0, NULL },
      { __("Load Video RAM..."), FILE_LOAD_VIDEORAM_ID, 0, NULL },
      { __("Save Video RAM... (F8)"), FILE_SAVE_VIDEORAM_ID, 0, NULL },
      ALLEGRO_MENU_SEPARATOR,
      { __("Exit (Alt-F4 / Ctrl-Q)"), FILE_EXIT_ID, 0, NULL },
      ALLEGRO_END_OF_MENU,

    { __("Display->"), DISPLAY_WINDOW_MENU, 0, NULL },
      { __("Scanlines On/Off"), DISPLAY_SCANLINES, scanlines ? ALLEGRO_MENU_ITEM_CHECKED : ALLEGRO_MENU_ITEM_CHECKBOX, NULL },
      ALLEGRO_MENU_SEPARATOR,
      { __("Smoothing On/Off"), DISPLAY_SMOOTHING, smoothing ? ALLEGRO_MENU_ITEM_CHECKED : ALLEGRO_MENU_ITEM_CHECKBOX, NULL },
      ALLEGRO_MENU_SEPARATOR,
...
#endif
#ifdef _WIN32
      { __("Full Screen (F11)"), DISPLAY_FULLSCREEN, 0, NULL },
#endif
#ifdef __APPLE__
      { __("Full Screen (Shift-F11)"), DISPLAY_FULLSCREEN, 0, NULL },
#endif
      ALLEGRO_END_OF_MENU,

    { __("Speed->"), 0, 0, NULL },
      { __("CPU Speed->"), 0, 0, NULL },
      ...
      ALLEGRO_MENU_SEPARATOR,
      { __("Sync On/Off"), SPEED_SYNC, Sync ? ALLEGRO_MENU_ITEM_CHECKED : ALLEGRO_MENU_ITEM_CHECKBOX, NULL },
      ALLEGRO_MENU_SEPARATOR,
      { __("Pause Emulation (F9)"), SPEED_PAUSE, ALLEGRO_MENU_ITEM_CHECKBOX, NULL },
      ALLEGRO_END_OF_MENU,

    { __("Keyboard->"), 0, 0, NULL },
      {__("[ZOEK] - Show Cassette Index in BASIC (F1)"), KEYBOARD_ZOEK_ID, 0, NULL },
      {__("[START] - Start Loaded Program in BASIC (F2)"), KEYBOARD_START_ID, 0, NULL },
      {__("[STOP] - Pause/Halt Program in BASIC (Shift-F2)"), KEYBOARD_STOP_ID, 0, NULL },
      {__("[WIS] - Clear Cassette in BASIC"), KEYBOARD_CLEARCAS_ID, 0, NULL },
      ALLEGRO_MENU_SEPARATOR,
      {__("Symbolic Key Mapping"), KEYBOARD_SYMBOLIC_ID, keyboardmap==1 ? ALLEGRO_MENU_ITEM_CHECKED : ALLEGRO_MENU_ITEM_CHECKBOX, NULL },
      {__("Positional Key Mapping"), KEYBOARD_POSITIONAL_ID, keyboardmap==0 ? ALLEGRO_MENU_ITEM_CHECKED : ALLEGRO_MENU_ITEM_CHECKBOX, NULL },
      ALLEGRO_END_OF_MENU,

    { __("Options->"), 0, 0, NULL },
      {soundDetected ? __("Sound On/Off (F10)") : __("Sound Card Not Detected"), OPTIONS_SOUND_ID, soundDetected ? (soundmode ? ALLEGRO_MENU_ITEM_CHECKED : ALLEGRO_MENU_ITEM_CHECKBOX) : ALLEGRO_MENU_ITEM_DISABLED, NULL },
      { __("Sound Volume->"), 0, 0, NULL },
        { __("High"), OPTIONS_VOLUME_HIGH_ID, ALLEGRO_MENU_ITEM_CHECKBOX, NULL },
        { __("Medium"), OPTIONS_VOLUME_MEDIUM_ID, ALLEGRO_MENU_ITEM_CHECKBOX, NULL },
        { __("Low"), OPTIONS_VOLUME_LOW_ID, ALLEGRO_MENU_ITEM_CHECKBOX, NULL },
        ALLEGRO_END_OF_MENU,
      ALLEGRO_MENU_SEPARATOR,
      {joyDetected ? __("Joystick On/Off") : __("Joystick Not Detected"), OPTIONS_JOYSTICK_ID, joyDetected ? (joymode ? ALLEGRO_MENU_ITEM_CHECKED : ALLEGRO_MENU_ITEM_CHECKBOX) : ALLEGRO_MENU_ITEM_DISABLED, NULL },
      { __("Joystick Mapping->"), OPTIONS_JOYSTICK_MAP, 0, NULL },
        { __("Emulate Cursorkeys + Spacebar"), OPTIONS_JOYSTICK_MAP_0_ID, joymode ? (joymap==0 ? ALLEGRO_MENU_ITEM_CHECKED : ALLEGRO_MENU_ITEM_CHECKBOX) : ALLEGRO_MENU_ITEM_DISABLED, NULL },
        { __("Fraxxon Mode (Left/Up/Spacebar)"), OPTIONS_JOYSTICK_MAP_1_ID, joymode ? (joymap==1 ? ALLEGRO_MENU_ITEM_CHECKED : ALLEGRO_MENU_ITEM_CHECKBOX) : ALLEGRO_MENU_ITEM_DISABLED, NULL },
        ALLEGRO_END_OF_MENU,
      ALLEGRO_MENU_SEPARATOR,
      { __("UI Language->"), 0, 0, NULL },
