...
static LanguageEntry NLstrings[] = {
  ...
  { FILE_INSERT_CASSETTE_ID, "Inlezen cassette..."},
  { FILE_INSERTRUN_CASSETTE_ID, "Inlezen en starten cassette..." },
  { FILE_REMOVE_CASSETTE_ID, "Verwijder cassette" },
  { FILE_INSERT_CARTRIDGE_ID, "Inlezen cartridge..." },
  ...
  { KEYBOARD_STOP_ID, "[STOP] - Pauzeer programma (Shift-F2)" },
