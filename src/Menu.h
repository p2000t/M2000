...
#define OPTIONS_VOLUME_MAX_ID (15 + OPTIONS_VOLUME_OFFSET)
#define OPTIONS_VOLUME_HIGH_ID (10 + OPTIONS_VOLUME_OFFSET)
#define OPTIONS_VOLUME_MEDIUM_ID (5 + OPTIONS_VOLUME_OFFSET)
...
void UpdateVolumeMenu (ALLEGRO_MENU *menu, int mastervolume) {
  al_set_menu_item_flags(menu, OPTIONS_VOLUME_MAX_ID, (OPTIONS_VOLUME_MAX_ID == mastervolume + OPTIONS_VOLUME_OFFSET) ? ALLEGRO_MENU_ITEM_CHECKED : ALLEGRO_MENU_ITEM_CHECKBOX);
...
ALLEGRO_MENU * CreateEmulatorMenu(ALLEGRO_DISPLAY *display, 
  ...
  ALLEGRO_MENU_INFO menu_info[] = {
    ...
    ALLEGRO_START_OF_MENU("Keyboard", 0),
      ...
      {"[WIS] - clear cassette (after confirmation)", KEYBOARD_CLEARCAS_ID, 0, NULL },
      ALLEGRO_MENU_SEPARATOR,
    ...
    ALLEGRO_START_OF_MENU("Options", 0),
      ...
      ALLEGRO_START_OF_MENU("Sound Volume", 0),
        { "Max", OPTIONS_VOLUME_MAX_ID, ALLEGRO_MENU_ITEM_CHECKBOX, NULL },
